...
Public Class Statement
	...
	Public Sub New(sql As String, connection As OdbcConnection)
		...
		Me._cmd = New OdbcCommand(sql, connection)
		Me._cmd.Prepare()
	End Sub
	''' <summary>
	''' Empty SQL statement constructor.
	...
	Public Sub New(sql As String, transaction As OdbcTransaction)
		MyBase.New(sql, transaction)
		Me._cmd = New OdbcCommand(sql, transaction.Connection, transaction)
		Me._cmd.Prepare()
	End Sub
